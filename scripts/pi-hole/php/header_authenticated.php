...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="index.php" class="logo">
            ...
            <span class="logo-lg"><strong><?=$languages["mahjoob"]?></strong></span>
        </a>
            ...
            <div class="navbar-custom-menu">
                ...
                <li class="dropdown language-dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                        <!-- يمكنك استخدام أيقونة أو نص هنا -->
                        <i class="fa fa-language"></i> <?php echo strtoupper($lang); ?> <span class="caret"></span>
                    </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <!-- <hr> -->
                                <a class="btn-link" href="logout.php" rel="noopener"><i class="fa fa-fw menu-icon fa-sign-out-alt"></i> <?php echo $languages['logout']; ?></a>
                                <?php } ?>
                            </li>
                        </ul>
                    </li>
