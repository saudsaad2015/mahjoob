            ...
            <div class="col-xs-12 col-sm-12 col-md-10">
                <ul class="<?php echo $list_class; ?>">
                    ...
                    <li>
                        ...
                        <?php if ($docker_update) { ?> &middot; <a class="lookatme" lookatme-text="Update available!" rel="noopener">Update available!</a><?php } ?>
                    </li>
                    <?php } ?>
                    <li>
                        <strong>Mahjoob</strong>
                        <?php echo $coreVersionStr; ?>
                        <?php if ($core_update) { ?> &middot; <a class="lookatme" lookatme-text="Update available!" href="" rel="noopener">Update available!</a><?php } ?>
                    </li>
                    <li>
                        <strong>FTL</strong>
                        <?php echo $ftlVersionStr; ?>
                        <?php if ($FTL_update) { ?> &middot; <a class="lookatme" lookatme-text="Update available!" href="" rel="noopener">Update available!</a><?php } ?>
                    </li>
                    <li>
                        <strong>Web Interface</strong>
                        <?php echo $webVersionStr; ?>
                        <?php if ($web_update) { ?> &middot; <a class="lookatme" lookatme-text="Update available!" rel="noopener">Update available!</a><?php } ?>
                    </li>
                </ul>
                ...
                <p style="margin: 15px 0 0;">
                    ...
                    <?php } elseif ($core_update || $web_update || $FTL_update) { ?>
                        To install updates, run <code><a href="https://docs.pi-hole.net/main/update/" rel="noopener" target="_blank">mahjoob -up</a></code>.
                    <?php } ?>
                </p>
            </div>
        </div>
