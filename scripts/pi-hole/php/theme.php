...
$available_themes['dark-theme'] = array('dark-theme', true, 'dark-theme', '#4488FF');
$available_themes['light-theme'] = array('light-theme', true, 'light-theme', '#4488FF');
